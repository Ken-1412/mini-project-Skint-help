...
export default function Auth() {
  ...
  const [selectedPortal, setSelectedPortal] = useState<string | null>(portalType || null);
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        await signUp(email, password, { role: (selectedPortal || 'public') as any });
            ...
            >
              <div className="text-center mb-12">
                ...
                <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white tracking-tight">
                  Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500">Portal</span>
                </h1>
