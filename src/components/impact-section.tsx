...
function ImpactCard({ icon, value, suffix = '', label, color, delay }: ImpactCardProps) {
...
function StatBar({ label, percentage, color }: StatBarProps) {
  return (
...
function HighlightCard({ title, value, description, icon }: HighlightCardProps) {
  return (
    <motion.div
